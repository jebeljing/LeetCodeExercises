...
public class ValidateIPAddress {
    ...
    public static void main(String... args) {
        ...
        System.out.println(test.validIPAddress("1081:db8:85a3:01:-0:8A2E:0370:7334"));
    }
    ...
    public String validIPAddress(String IP) {
        ...
        if (IP.contains(".")) {
            ...
            for(String str: strs) {
                ...
                if (str.length() == 0 || str.startsWith("-")) return "Neither";
                try {
            ...
            for (String str: strs) {
                if (str.length() == 0 || str.length() > 4 || str.startsWith("-")) return "Neither";
                try {
                    Integer value = Integer.valueOf(str, 16);

                    if (value < 0 || value > max) return "Neither";
                } catch (Exception e) {
                    return "Neither";
                }
            }
